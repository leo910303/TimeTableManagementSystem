<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="TimeTableManagementSystem_Update.Dashboard" %>
                ...
                <div class="box-body">
                  <ul class="todo-list">
                    <li>
                      ...
                      <!-- todo text -->
                      <span class="text">New User Added</span>
                      <!-- Emphasis label -->
                    ...
                    <li>
                      ...
                      <input type="checkbox" value="" name=""/>
                      <span class="text">New Branch Added</span>
                    ...
                    <li>
                      ...
                      <input type="checkbox" value="" name=""/>
                      <span class="text">Profile Changed</span>
                    ...
                    <li>
                      ...
                      <input type="checkbox" value="" name=""/>
                      <span class="text">Faculty Detail Updated</span>
                ...
                <div class="box-body no-padding">
                  <ul class="users-list clearfix">
                    <li>
                      ...
                      <a class="users-list-name" href="#">Sachith Gunasekara</a>
