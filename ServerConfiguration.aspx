<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServerConfiguration.aspx.cs" Inherits="TimeTableManagementSystem.ServerConfiguration" %>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <div id="DIV1" style="position:absolute; left: 50%;">
            <asp:Label ID="lblHeadingOT" runat="server" Text="Manage Server Details" Font-Size="30" Font-Bold="true"></asp:Label>
        </div>
       
            <div id="divtab" style="position: absolute; top: 50%;">
                <ul class="nav nav-tabs" >
                    <li class="active"><a data-toggle="tab" href="#EmailServer">Email Server</a></li>
                    <li><a data-toggle="tab" href="#DatabaseServer">Database Server</a></li>
                </ul>
                <div class="tab-content">
            
                <div id="EmailServer" class="tab-pane fade in active">
                    
                    
                    <div id="div10" style="position: absolute; top: 95%; left: -2px; width: 1027px; margin-top: 1px;">
                    ...
                    <div id="div7" style="position: absolute; top: 89px; left: 201px; height: 22px; width: 192px;">
                        <asp:Label ID="Label2" runat="server" Text="Database Server Address :"></asp:Label>
                    </div>  
                    
                    <div id="div8" style="position: absolute; top: 87px; left: 415px;">
                        <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                    </div>
                    
                    <div id="div9" style="position: absolute;top: 122px; left: 209px; width: 186px;">
                        <asp:Label ID="Label3" runat="server" Text="Database :"></asp:Label>
                    </div>  
                    
                    <div id="div113" style="position: absolute; top: 192px; left: 417px;">
                        <asp:TextBox ID="TextBox2" runat="server"></asp:TextBox>
                    </div>
                    
                    <div id="div11" style="position: absolute; top: 158px; left: 210px; height: 22px; width: 153px;">
                        <asp:Label ID="Label4" runat="server" Text="User Id :"></asp:Label>
                    </div> 
                    
                    <div id="div12" style="position: absolute; top: 121px; left: 416px;">
                        <asp:TextBox ID="TextBox3" runat="server"></asp:TextBox>
                    </div>
                    
                    <div id="div13" style="position: absolute; top: 193px; left: 205px; height: 22px; width: 190px;">
                        <asp:Label ID="Label5" runat="server" Text="Password :"></asp:Label>
                    </div> 
                    
                    <div id="div14" style="position: absolute; top: 156px; left: 417px;">
                    ...
                    <div id="div25" style="position: absolute; top: 600%; left: 842px; height: 31px; width: 62px; right: -51px;">
                        <asp:Button ID="Button6" runat="server" Text="Save" CssClass="btn btn-block btn-primary" Height="31px" Width="66px" />
                    </div>
                    
                    <div id="div26" style="position: absolute; top: 700%; left: -2px; width: 1027px; margin-top: 1px;">
                ...
                <div id="DatabaseServer" class="tab-pane fade">
                    <div id="div27" style="position: absolute; top: 89px; left: 222px; height: 22px; width:192px;">
                        <asp:Label ID="Label1" runat="server" Text="Database Server Address :"></asp:Label>
                    </div>  
                    ...
                    <div id="div29" style="position: absolute;top: 122px; left: 222px; width:190px;">
                        <asp:Label ID="Label32" runat="server" Text="Database :"></asp:Label>
                    </div>  
                    ...
                    <div id="div31" style="position: absolute; top: 158px; left: 222px; height: 22px; width:190px;">
                        <asp:Label ID="Label43" runat="server" Text="User Id :"></asp:Label>
                    </div> 
                    ...
                    <div id="div33" style="position: absolute; top: 193px; left: 222px; height: 22px; width:190px;">
                    ...
                    <div id="div34" style="position: absolute; top: 156px; left: 417px;">
                      ...
                      <div id="div35" style="position: absolute; top: 320px; left: 842px; height: 31px; width: 62px; right: -51px;">
                        <asp:Button ID="Button26" runat="server" Text="Save" CssClass="btn btn-block btn-primary" Height="31px" Width="66px" />
                    </div>
