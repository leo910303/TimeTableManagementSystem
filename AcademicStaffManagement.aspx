            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-red">
                ...
                <a href="#" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                        ...
                        <div id="DIV1" style="position: absolute; left: 41%; top: 53px; width: 453px;">
                            <asp:Label ID="lblHeadingOT" runat="server" Text="Manage Academic Staff" Font-Size="30" Font-Bold="true"></asp:Label>
                        </div>

                        <div id="div2" style="position: absolute; top: 140px; left: 310px; height: 107px; width: 123px;">
                            <asp:Image ID="Image1" runat="server" ImageUrl="~/dist/img/user.png" CssClass="img-circle" Height="101px" Width="117px" />
                        </div>

                        <div id="div4" style="position: absolute; top: 253px; left: 309px; height: 24px; width: 223px;">
                            <asp:FileUpload ID="FileUpload1" runat="server" />
                        </div>

                        <div id="div3" style="position: absolute; top: 179px; left: 567px; height: 22px;">
                            <asp:Label ID="Label81" runat="server" Text="Staff ID :"></asp:Label>
                        </div>

                        <div id="div5" style="position: absolute; top: 213px; left: 658px;">
                        ...
                        <div id="div6" style="position: absolute; top: 213px; left: 568px;">
                            <asp:Label ID="Label22" runat="server" Text="Designation :"></asp:Label>
                        </div>

                        <div id="div7" style="position: absolute; top: 182px; left: 657px;">
                            <asp:TextBox ID="TextBox52" runat="server"></asp:TextBox>
                        </div>

                        <div id="div8" style="position: absolute; top: 249px; left: 569px; height: 22px;">
                            <asp:Label ID="Label53" runat="server" Text="Title :"></asp:Label>
                        </div>


                        <div id="div9" style="position: absolute; top: 248px; left: 660px;">
                        ...
                        <div id="divtab" style="position: absolute; top: 55%;">
                            ...
                            <div class="tab-content">
                                ...
                                <div id="PersonalDetails" class="tab-pane fade in active">
                                    ...
                                    <div id="div13" style="position: absolute; top: 82px; left: 138px; height: 23px; width: 78px; right: 240px;">
                                        <asp:Label ID="Label5" runat="server" Text="First Name :"></asp:Label>
                                    </div>

                                    <div id="div14" style="position: absolute; top: 84px; left: 227px;">
                                        <asp:TextBox ID="TextBox53" runat="server"></asp:TextBox>
                                    </div>

                                    <div id="div15" style="position: absolute; top: 82px; left: 415px; height: 23px; width: 81px; right: -40px;">
                                        <asp:Label ID="Label6" runat="server" Text="Last Name :"></asp:Label>
                                    </div>

                                    <div id="div16" style="position: absolute; top: 84px; left: 511px;">
                                        <asp:TextBox ID="TextBox34" runat="server"></asp:TextBox>
                                    </div>                                
                                   

                                    <div id="div30" style="position: absolute; top: 122px; left: 225px;">
                                        <asp:TextBox ID="TextBox41" runat="server"></asp:TextBox>
                                    </div>

                                    <div id="div29" style="position: absolute; top: 156px; left: 138px; height: 22px;">
                                        <asp:Label ID="Label2" runat="server" Text="Join Date :"></asp:Label>
                                    </div>

                                    <div id="div130" style="position: absolute; top: 155px; left: 225px;">
                                        <asp:TextBox ID="txtJoinDate" runat="server"></asp:TextBox>
                                    </div>


                                    <div id="div27" style="position: absolute; top: 151px; left: 418px; height: 22px; width: 64px;">
                                        <asp:Label ID="Label1" runat="server" Text="Address :"></asp:Label>
                                    </div>

                                    <div id="div28" style="position: absolute; top: 153px; left: 512px;">
                                        <asp:TextBox ID="TextBox6" runat="server"></asp:TextBox>
                                    </div>


                                    <div id="div31" style="position: absolute; top: 119px; left: 417px; height: 22px; width: 72px;">
                                        <asp:Label ID="Label43" runat="server" Text="Mobile No :"></asp:Label>
                                    </div>


                                    <div id="div33" style="position: absolute; top: 122px; left: 140px; height: 22px;">
                                        <asp:Label ID="Label44" runat="server" Text="Email :"></asp:Label>
                                    </div>

                                    <div id="div34" style="position: absolute; top: 118px; left: 512px;">
                                        <asp:TextBox ID="TextBox43" runat="server"></asp:TextBox>
                                    </div>

                                    <div id="div35" style="position: absolute; top: 195px; left: 582px; height: 31px; width: 62px; right: -188px;">
                                ...
                                <div id="ChangePassword" class="tab-pane fade in active">
                                     <div id="div137" style="position: absolute; top: 102px; left: 155px; height: 22px;">
                                        <asp:Label ID="Label3" runat="server" Text="Current Password :"></asp:Label>
                                    </div>

                                    <div id="div138" style="position: absolute; top: 102px; left: 304px;">
                                        <asp:TextBox ID="txtCurrentPw" runat="server"></asp:TextBox>
                                    </div>

                                    <div id="div139" style="position: absolute; top: 137px; left: 155px; width: 106px; height: 26px;">
                                        <asp:Label ID="Label4" runat="server" Text="New Password :"></asp:Label>
                                    </div>

                                    <div id="div140" style="position: absolute; top: 138px; left: 303px;">
                                        <asp:TextBox ID="txtNewPw" runat="server"></asp:TextBox>
                                    </div>

                                    <div id="div141" style="position: absolute; top: 174px; left: 156px; height: 22px;">
                                        <asp:Label ID="Label7" runat="server" Text="Confirm Password :"></asp:Label>
                                    </div>

                                    <div id="div142" style="position: absolute; top: 174px; left: 303px;">
