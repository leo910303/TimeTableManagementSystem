<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Main.aspx.cs" Inherits="TimeTableManagementSystem.Physical_Module.Main" UnobtrusiveValidationMode="None"%>
         ...
         <div id="mainContent" class="container-fluid">
             <div class="row">
                <ul class="nav nav-tabs">
                    <li role="presentation" class="active"><a href="#"><strong>Insert Physical Resources</strong> </a></li>
                    <li role="presentation"><a href="#">Manage Physical Resources</a></li>
          ...
          <div class="form-group">
              <div class="row">
                <asp:Label ID="Label2" runat="server" Text="Name" CssClass="col-sm-offset-1 col-sm-2" Font-Bold="True"></asp:Label>
                    <div class="col-sm-3">
                        <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control" ToolTip="Enter name"></asp:TextBox>
                             <asp:RequiredFieldValidator runat="server" style="color:red" controltovalidate="TextBox1" errormessage="Please enter the name!" />
                    </div>
              </div>
           </div>
          <div class="form-group">
              <div class="row">
                <asp:Label ID="Label3" runat="server" Text="Location" CssClass="col-sm-offset-1 col-sm-2" Font-Bold="True"></asp:Label>
                    <div class="col-sm-3">
                         <asp:DropDownList ID="DropDownList3" runat="server" CssClass="form-control" ToolTip="Select location"></asp:DropDownList>
                    </div>
              </div>
          </div>
             <div class="form-group">
          ...
          <div class="form-group">
              <div class="row">
                    <asp:Label ID="Label4" runat="server" Text="Capacity" CssClass="col-sm-offset-1 col-sm-2" Font-Bold="True"></asp:Label>
                        <div class="col-sm-3">      
                            <asp:TextBox ID="TextBox2" runat="server" CssClass="form-control" ToolTip="Enter Capacity"></asp:TextBox>
                             <asp:RequiredFieldValidator runat="server" style="color:red" controltovalidate="TextBox2" errormessage="Please enter your name!" />                                            
                        </div>
              </div>
            </div>
          <div class="form-group">
              <div class="row">
                  <div class="col-sm-offset-1 col-sm-2" >
                    <asp:Button ID="Button3" runat="server" Text="Add resource" CssClass="btn btn-success "/>
                  </div>
